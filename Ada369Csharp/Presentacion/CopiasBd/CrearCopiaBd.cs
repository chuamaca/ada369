...
{
    public partial class CrearCopiaBd : DevComponents.DotNetBar.Metro.MetroForm
    {
        public CrearCopiaBd()
        {
            InitializeComponent();
        ...
        private void CrearCopiaBd_Load(object sender, EventArgs e)
        {
            ...
            Pcargando.BackColor = Color.White;
        ...
        private void Mostrar_empresa()
        {
            ...
            foreach (DataRow row in dt.Rows )
            {
                ...
                lbldirectorio.Text = "Copia Guardada en: " + txtRuta.Text  + "DBDPOS.bak";
