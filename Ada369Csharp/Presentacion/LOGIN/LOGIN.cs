...

        {
            ...
            while (rdr.Read())
            {
                ...
                I1.Dock = DockStyle.Top;
                    //I1.BackColor = Color.FromArgb(46,140,186);
      ...
      private void validar_conexion()
        {
            ...
            if (INDICADOR == "CORRECTO")
            {
                ...
                else
                {
                    ...
                    PanelRestaurarCuenta.BackColor = Color.White;
                    DIBUJARusuarios();
                }
            }
            ...
            if (INDICADOR == "INCORRECTO")
            {
                ...
                Presentacion.ASISTENTE_DE_INSTALACION_servidor.Eleccion_Servidor_o_remotoD frm = new Presentacion.ASISTENTE_DE_INSTALACION_servidor.Eleccion_Servidor_o_remotoD();
                frm.ShowDialog();
        ...
        private void btnRestaurarCuenta_Click(object sender, EventArgs e)
        {
            //PanelRestaurarCuenta.Visible = true;
            //PanelIngreso_de_contraseña.Visible = false;
            //mostrar_correos();
