...
{
    public partial class Eleccion_Servidor_o_remotoD : DevComponents.DotNetBar.Metro.MetroForm
    {
        public Eleccion_Servidor_o_remotoD()
        {
            InitializeComponent();
        }
        ...
        private void btnInstalarServer_Click(object sender, EventArgs e)
        {
            Dispose();
        ...
        private void Eleccion_Servidor_o_remotoD_Load(object sender, EventArgs e)
        {
        ...
        private void btnInstalarCliente_Click(object sender, EventArgs e)
        {
            Dispose();
