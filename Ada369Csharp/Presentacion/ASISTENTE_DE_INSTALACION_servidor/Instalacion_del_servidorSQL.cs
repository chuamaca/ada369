...
{
    public partial class Instalacion_del_servidorSQL : DevComponents.DotNetBar.Metro.MetroForm
    {
        ...
        private void comprobar_si_ya_hay_servidor_instalado_SQL_EXPRESS()
        {
            ...
            //COMPROBACION DE SI EL SQL ES EXPRESS O NO
            var sqlexx = txtservidor.Text;
            if (sqlexx!="" ) {


                MessageBox.Show("El servidor es " + sqlexx);
