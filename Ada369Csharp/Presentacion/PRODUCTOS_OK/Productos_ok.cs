...
{
    public partial class Productos_ok : DevComponents.DotNetBar.Metro.MetroForm
    {
        int txtcontador;
        ...
        private void Productos_ok_Load(object sender, EventArgs e)
        {
            ...
            PANELDEPARTAMENTO.BackColor = Color.White;
            ...
            MenuStrip9.BackColor = Color.White;
        ...
        //PARA OBTNER EL IGV Y PLAICAR SOBRE EL COSTO DEL PRECIO COMPRA
        ...
        private void insertar_productos()
        {
            ...
            try
            {
                ...
                {
                    cmd.Parameters.AddWithValue("@Impuesto", obtenerIGV);

                    MessageBox.Show("EL IGV ES " + obtenerIGV);
                }
                else if (chkIGV.Checked == false)
                {
                    cmd.Parameters.AddWithValue("@Impuesto", 0);

                    MessageBox.Show("EL IGV ES " + 0);
                }
        ...
        private void txtcosto_TextChanged_1(object sender, EventArgs e)
        {
            ...
            //}
                ...
                //double precioFFINAL;
                //double miPrecioCosto = Convert.ToDouble(txtcosto.Text);

                //if (chkIGV.Checked.Equals(true))
                //{
                //    precioFFINAL = Convert.ToDouble(((miPrecioCosto * obtenerIGV) + miPrecioCosto));
                //    lblMSprecioFinal.Text = "PRECIO FINAL ES " + precioFFINAL.ToString();
                //    //MessageBox.Show("ES VERDADERO EL CHECK EN EDITAR");


                //}
                //if (chkIGV.Checked.Equals(false))
                //{
                //    lblMSprecioFinal.Text = "PRECIO FINAL ES " + miPrecioCosto.ToString();
        ...
        //private void AgravarIGV() {

        //    double Preciounitario;
        //    double subtotal;
        //    Preciounitario = Convert.ToDouble(txtcosto.Text);

        //    if (chkIGV.Checked==true)
        //    {

        //         subtotal = Convert.ToDouble(((Preciounitario * obtenerIGV) + Preciounitario));
        //        lblMSprecioFinal.Text = "PRECIO FINAL ES " + subtotal.ToString();
        //    }
        //    if(chkIGV.Checked==false)
        //    {
        //        lblMSprecioFinal.Text = "PRECIO FINAL ES "+ Preciounitario;
        //    }
        ...
        internal void proceso_para_obtener_datos_de_productos()
        {
            ...
            try
            {
                ...
                //AGREADO DE LINEA PARA CALCULAR CON IGV
                double captandoIGV = Convert.ToDouble(datalistado.SelectedCells[6].Value.ToString());
