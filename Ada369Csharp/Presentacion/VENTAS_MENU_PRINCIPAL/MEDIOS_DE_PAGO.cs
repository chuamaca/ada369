...
{
    public partial class MEDIOS_DE_PAGO : DevComponents.DotNetBar.Metro.MetroForm
    {
        ...
        void configuraciones_de_diseño()
        {
            ...
            //CAPTAMOS LOS DATOS DEL ANTERIOR FORMULARIO
            total = VENTAS_MENU_PRINCIPALOK.total;
            obtenerIGVinsertar = VENTAS_MENU_PRINCIPALOK.ivgpasarventa;
        ...
        void CONFIRMAR_VENTA_EFECTIVO()
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@IGV", obtenerIGVinsertar);
