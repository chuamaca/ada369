...
{
    public partial class INVENTARIO_MENU : DevComponents.DotNetBar.Metro.MetroForm
    {
...
buscar_MOVIMIENTOS_FILTROS();
        ...
        private void INVENTARIO_MENU_Load(object sender, EventArgs e)
        {
            ...
            PanelKardex.BackColor = Color.White;
            PanelM.BackColor = Color.White;
            PanelK.BackColor = Color.White;
            PanelI.BackColor = Color.White;
            PanelR.BackColor = Color.White;
            Panelv.BackColor = Color.White;
            groupBox1.BackColor = Color.White;
            PanelMOVIMIENTOS.BackColor = Color.White;
            PanelREPORTEInventario.BackColor = Color.White;
            PaneliNVENTARIObajo.BackColor = Color.White;
            PanelVencimientos.BackColor = Color.White;
            txtbuscarKardex_movimientos.BackColor = Color.White;
