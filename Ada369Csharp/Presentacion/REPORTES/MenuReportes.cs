...
{
    public partial class MenuReportes : DevComponents.DotNetBar.Metro.MetroForm
    {
        public MenuReportes()
        {
            InitializeComponent();
        ...
        private void MenuReportes_Load(object sender, EventArgs e)
        {
            ...
            btnInventarios.BackColor = Color.White;
            btnPvencidos.BackColor = Color.White;
            btnStockBajo.BackColor = Color.White;
            btnResumenVentas.BackColor = Color.White;
            PVentasPorempleado.BackColor = Color.White;
